...
<head>
    ...
    <title>{{ $title ?? "Signet Control Room" }}</title>
    ...
    <main class="flex-1 overflow-y-auto bg-[#0a0a0a] flex flex-col">
        ...
        <footer class="py-4 px-8 border-t border-gray-800/50 mt-auto">
            <div class="flex items-center justify-between text-xs text-gray-500 font-medium">
                ...
                <span class="font-mono text-[10px] font-bold tracking-widest text-red-400 bg-red-500/10 px-2 py-0.5 rounded border border-red-500/20">
                    v{{ config("app.version", "1.0.0") }} - ADMIN
                </span>
            </div>
        </footer>
