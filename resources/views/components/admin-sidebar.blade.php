    ...
    <div class="overflow-y-auto overflow-x-hidden no-scrollbar">
        ...
        <nav class="p-4 space-y-6">
            ...
            <div class="space-y-1">
                ...
                <a class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors text-gray-400 hover:text-white hover:bg-white/5{{ request()->routeIs("admin.workspaces.*") ? "bg-red-500/10 text-red-400" : "text-gray-400 hover:text-white hover:bg-white/5" }}" href="{{ route("admin.workspaces.index") }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
